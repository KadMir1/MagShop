...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private void updateOnlyUserInfo()
    {
        ...
        Toast.makeText(SettingsActivity.this, "Информация профиля обновлена успешно", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private void uploadImage()
    {
        ...
        progressDialog.setTitle("Профиль обновлён");
        progressDialog.setMessage("Пожалуйста подождите, мы обновляем ваш профиль");
